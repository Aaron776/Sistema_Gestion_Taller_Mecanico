        ...
        <table>
            <tr>
                <td>
                    ...
                    <div class="report-title">Reporte de Órdenes de Servicio</div>
                </td>
...
if (empty($ordenes)) {
    ...
    foreach ($ordenes as $o) {
        $html .= '
                <tr>
                    <td><strong>OS-' . date('Y') . '-' . htmlspecialchars($o['id_orden_servicio']) . '</strong></td>
...
$dompdf->stream("reporte_ordenes_servicios.pdf", ["Attachment" => true]);
