        ...
        <table>
            <tr>
                <td>
                    ...
                    <div class="report-title">Reporte de Órdenes Rechazadas</div>
                </td>
...
if (empty($ordenes)) {
    ...
    foreach ($ordenes as $o) {
        $html .= '
                <tr>
                    <td><strong>ORD-' . date('Y') . '-' . htmlspecialchars($o['id_orden']) . '</strong></td>
                    ...
                    <td>' . htmlspecialchars($o['motivo_rechazo']) . '</td>
                </tr>';
    }
}
...
$dompdf->stream("reporte_ordenes_rechazadas.pdf", ["Attachment" => true]);
