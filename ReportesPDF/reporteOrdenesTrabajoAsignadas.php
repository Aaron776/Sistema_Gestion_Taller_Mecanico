        ...
        <table>
            <tr>
                <td>
                    ...
                    <div class="report-title">Reporte de Órdenes Asignadas</div>
                </td>
...
if (empty($ordenes)) {
    ...
    foreach ($ordenes as $o) {
        $statusClass = 'status-' . str_replace('_', '-', $o['estado']);
        $html .= '
                <tr>
                    ...
                    <td><span class="status-badge ' . $statusClass . '">' . strtoupper(htmlspecialchars($o['estado'])) . '</span></td>
                </tr>';
    }
}
...
$dompdf->stream("reporte_ordenes_asignadas.pdf", ["Attachment" => true]);
