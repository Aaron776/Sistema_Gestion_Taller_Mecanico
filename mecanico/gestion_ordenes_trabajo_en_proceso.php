...
<div class="card">
    <div class="card-header">
        <h2 class="card-title">Lista de Órdenes de Trabajo en Proceso</h2>
        <div class="search-container" style="flex-wrap: wrap; gap: 10px;">
            <a href="../ReportesPDF/reporteOrdenesTrabajoEnProceso.php" class="btn btn-danger">
                <i class="fas fa-file-pdf"></i> PDF
            </a>
            <a href="../ReportesExcel/reporteOrdenesTrabajoEnProceso.php" class="btn btn-success">
                        ...
                        <tr>
                            <td colspan="8">
                                <div class="empty-state">
                                    ...
                                    <p>No tienes órdenes de trabajo en proceso en este momento.</p>
                                </div>
                            </td>
                        </tr>
                    <?php else : ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="display: flex; gap: 5px;">
                                        <a href="editar_estado_orden_trabajo_en_proceso.php?id_orden=<?php echo htmlspecialchars(base64_encode($item->id_orden)); ?>&id_cliente=<?php echo htmlspecialchars(base64_encode($item->id_cliente)); ?>" type="button" class="btn-action btn-action-primary">
                                            <i class="fas fa-edit"></i> Editar Estado
                                        </a>
                                        <a href="crear_ordenes_repuestos.php?id_orden=<?php echo htmlspecialchars(base64_encode($item->id_orden)); ?>" type="button" class="btn-action btn-action-success">
