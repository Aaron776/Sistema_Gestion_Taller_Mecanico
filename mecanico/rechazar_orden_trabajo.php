...
$sql = $conexion->prepare("SELECT id_orden,id_cliente,estado,fecha_creacion FROM ordenes_trabajo WHERE id_orden = :id_orden");
...
<div class="card">
    ...
    <div class="card-body">
        <form id="estadoForm" class="status-form" method="POST" action="../controladores/rechazar_orden_trabajo.php">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="motivoRechazo" name="motivo_rechazo" required></textarea>
            </div>
