...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['id_orden']) && isset($_POST['id_cliente']) && isset($_POST['estado'])) {
    ...
    if (empty($errores)) {
        ...
        header("Location: ../mecanico/editar_estado_orden_trabajo_en_proceso.php?id_orden=" . base64_encode($id_orden) . "&id_cliente=" . base64_encode($id_cliente));
        exit();
    }
} else {
